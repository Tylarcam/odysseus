...
const _LABELS = {
  ...
  'cmd-center-panel':{ label: 'CMD Center', icon: 'M12 12m-3 0a3 3 0 1 0 6 0a3 3 0 1 0-6 0M12 4v2M12 18v2M4 12h2M18 12h2M12 12m-8 0a8 8 0 1 0 16 0a8 8 0 1 0-16 0' },
  ...
  'split-chat-modal':  { label: 'Split chat', icon: 'M2 3h8v18H2zM14 3h8v18h-8z' },
...
const _AUTO_WIRE = {
  ...
  'agent-bin-modal':      { rail: 'rail-agent-bin', sidebar: 'tool-agent-bin-btn' },
  ...
  'cmd-center-panel':   { rail: 'rail-cmd-center', sidebar: 'tool-cmd-center-btn' },

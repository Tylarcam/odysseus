...
const _ENDPOINT_LABELS = [
  ...
  [/(^|\.)minimaxi\.com$/i, "MiniMax"],
  [/(^|\.)minimax\.chat$/i, "MiniMax"],
  [/(^|\.)together\.(ai|xyz)$/i, "Together"],
  [/(^|\.)fireworks\.ai$/i, "Fireworks"],
  [/(^|\.)perplexity\.ai$/i, "Perplexity"],
  [/(^|\.)nvidia\.com$/i, "NVIDIA"],
  [/(^|\.)x\.ai$/i, "xAI"],
  [/(^|\.)cloudflare\.com$/i, "Cloudflare Workers AI"],
];
